...
class LegDataLoader():
    ...
    def __init__(self, batch_size = 32, grid = 7, data_path="/home/athdom/GaitTracking/data/", paths = ["p18/3.a","p5/2.a", "p11/2.a", "p1/2.a", "p16/3.a", "p17/2.a", "p17/3.a", "p18/2.a", "p11/3.a"]):
        self.grid = grid
