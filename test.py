...
img = torch.load("/home/danai/Desktop/GaitTracking/p5/2.a/data/2195.pt")
label = torch.load("/home/danai/Desktop/GaitTracking/p5/2.a/labels/2195.pt")

label1 = torch.load("/home/danai/Desktop/GaitTracking/p5/2.a/labels/2800.pt")
...
print(loss(torch.stack([yh, yh], dim = 0), torch.stack([label1, label1], dim = 0)))
